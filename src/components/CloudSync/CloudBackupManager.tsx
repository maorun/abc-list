      ...
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">Backup {backup.id.split('_').pop()}</span>
      ...
      {showDetails && (
        <div className="pt-3 border-t space-y-2">
          <div className="text-sm">
            <p><strong>Checksum:</strong> <code className="text-xs">{backup.checksum}</code></p>
            <p><strong>Gerät:</strong> {backup.deviceInfo.platform}</p>
            <p><strong>User Agent:</strong> <span className="text-xs">{backup.deviceInfo.userAgent}</span></p>
          </div>
        </div>
      )}
    </div>
...
export function CloudBackupManager() {
  const { isAuthenticated, createBackup, restoreBackup, listBackups, lastError, clearError } = useCloudBackup();
  ...
  const handleCreateBackup = handleCreateBackupAction(createBackup, setIsCreating, clearError);
  const handleLoadBackups = handleLoadBackupsAction(listBackups, setBackups, setIsLoading, clearError);

  const handleRestoreBackup = (backupId: string) => {
    handleRestoreBackupAction(restoreBackup, backupId, setIsRestoring, clearError, setShowDialog)();
  };
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              Ein Backup enthält alle Ihre ABC-Listen, KaWa, KaGa und Einstellungen.
            </p>
          </div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h5 className="font-medium text-blue-900 mb-2">Backup-Informationen</h5>
