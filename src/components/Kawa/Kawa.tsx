...
export function Kawa() {
  ...
  const [itemToDelete, setItemToDelete] = useState<NewItemWithSaveKey | undefined>(undefined);
  ...
  return (
    <div className="p-4">
      ...
      <p className="text-center text-gray-500 mt-4">Tipp: Rechtsklick zum Löschen</p>
    </div>
  );
}
